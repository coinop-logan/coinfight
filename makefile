...
bin/test: cpp/obj/test.o cpp/obj/engine.o cpp/obj/vchpack.o cpp/obj/myvectors.o cpp/obj/cmds.o cpp/obj/common.o cpp/obj/graphics.o cpp/obj/coins.o cpp/obj/sigWrapper.o cpp/obj/graphics.o
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LIB)
